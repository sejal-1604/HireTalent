...
import HeroImg from '../../assets/bg_clg_proj.png';
  ...
  return (
    ...
    >
      ...
      <div className="relative z-20 max-w-5xl text-center">
        ...
        <span style={{ color: '#0f3f3c' }}>
          Empower Your Career with <br />
        </span>
        <span className="bg-gradient-to-r from-[#1e4b48] via-[#2e6562] to-[#3d817b] text-transparent bg-clip-text">
         Hire Talent
        </span>
