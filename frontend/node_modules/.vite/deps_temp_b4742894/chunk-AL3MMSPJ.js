...
var Overlay = React.forwardRef((props, outerRef) => {
  ...
  const [exited, setExited] = (0, import_react6.useState)(!props.show);
...
function useOverlayOffset(customOffset) {
  ...
  const offset2 = (0, import_react7.useMemo)(() => ({
    name: "offset",
    options: {
      offset: () => {
        if (customOffset) {
...
var Overlay2 = React5.forwardRef(({
  ...
  const popperRef = (0, import_react8.useRef)({});
  const [firstRenderedState, setFirstRenderedState] = (0, import_react8.useState)(null);
...
var OverlayTrigger = ({
  ...
  const triggerNodeRef = (0, import_react9.useRef)(null);
  const mergedRef = useMergedRefs_default(triggerNodeRef, children.ref);
  const timeout = useTimeout();
  const hoverStateRef = (0, import_react9.useRef)("");
  ...
  const handleShow = (0, import_react9.useCallback)(() => {
    timeout.clear();
  ...
  const handleFocus = (0, import_react9.useCallback)((...args) => {
    handleShow();
    onFocus == null || onFocus(...args);
  }, [handleShow, onFocus]);
  const handleBlur = (0, import_react9.useCallback)((...args) => {
    handleHide();
    onBlur == null || onBlur(...args);
  }, [handleHide, onBlur]);
  const handleClick = (0, import_react9.useCallback)((...args) => {
    setShow(!show);
    onClick == null || onClick(...args);
  }, [onClick, setShow, show]);
  const handleMouseOver = (0, import_react9.useCallback)((...args) => {
    handleMouseOverOut(handleShow, args, "fromElement");
  }, [handleShow]);
  const handleMouseOut = (0, import_react9.useCallback)((...args) => {
  ...
  return (0, import_jsx_runtime8.jsxs)(import_jsx_runtime7.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react9.cloneElement)(children, triggerProps), (0, import_jsx_runtime6.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip: flip2,
...
//# sourceMappingURL=chunk-AL3MMSPJ.js.map
